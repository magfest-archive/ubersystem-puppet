...
# it generates a CA and client certificate, for use with the RAMS Json-RPC API + Nginx
...
then
    ...
    echo "example:"
    echo "$0 rams US MD Baltimore "MagfestINC" "onsite.uber.magfest.org""
    exit -1
fi
...
# these MUST BE different common names, or SSL verification won't work.
